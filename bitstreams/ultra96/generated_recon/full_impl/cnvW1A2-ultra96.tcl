...
set rc [catch {
  ...
  add_files -quiet D:/Adam/Documents/Vivado_Projects/IoT-Recon/IoT-Recon.runs/synth_1/super_wrapper.dcp
  ...
  set_property SCOPED_TO_CELLS BLACKBOX_WRAPPER [get_files D:/Adam/Documents/Vivado_Projects/IoT-Recon/IoT-Recon.runs/cnvW1A2_wrapper_synth_1/cnvW1A2_wrapper.dcp]
  set_property netlist_only true [get_files D:/Adam/Documents/Vivado_Projects/IoT-Recon/IoT-Recon.runs/cnvW1A2_wrapper_synth_1/cnvW1A2_wrapper.dcp]
...
set rc [catch {
  ...
  write_checkpoint -force -cell BLACKBOX_WRAPPER BLACKBOX_WRAPPER_cnvW1A2_wrapper_routed.dcp
...
set rc [catch {
  ...
  write_checkpoint -force -cell BLACKBOX_WRAPPER BLACKBOX_WRAPPER_cnvW1A2_wrapper_post_routed.dcp
...
set rc [catch {
  ...
  update_design -cell BLACKBOX_WRAPPER -black_box
  lock_design -level routing
  write_checkpoint -force super_wrapper_postroute_physopt_bb.dcp
