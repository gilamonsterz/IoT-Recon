...
HD_PWD='D:/Adam/Documents/Vivado_Projects/IoT-Redeaux/Wrapped/cnvW1A2/cnvW1A2.runs/BBJ_u96_cnvW1A2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BBJ_u96_cnvW1A2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BBJ_u96_cnvW1A2_0.tcl
