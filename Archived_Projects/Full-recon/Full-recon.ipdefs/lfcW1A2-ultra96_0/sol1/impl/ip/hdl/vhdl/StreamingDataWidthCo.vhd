...
architecture behav of StreamingDataWidthCo is 
    ...
    signal tmp_1_i_reg_206 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal p_1_i_reg_77 : STD_LOGIC_VECTOR (47 downto 0);
    ...
    signal tmp_5_i_fu_144_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_5_i_reg_201 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_1_i_fu_150_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_1_i_reg_206_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal p_1_cast_i_fu_162_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((tmp_1_i_reg_206 = ap_const_lv1_1) and (exitcond_i_reg_187_pp0_iter1_reg = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_i_reg_187 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    p_1_i_reg_77_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_i_reg_187_pp0_iter2_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                p_1_i_reg_77 <= ap_phi_mux_p_Val2_s_phi_fu_115_p4(63 downto 16);
            elsif ((not(((ap_start = ap_const_logic_0) or (numReps_out_full_n = ap_const_logic_0) or (numReps_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                p_1_i_reg_77 <= ap_const_lv48_0;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_i_fu_127_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                ...
                tmp_1_i_reg_206_pp0_iter2_reg <= tmp_1_i_reg_206;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_i_fu_127_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                ...
                tmp_5_i_reg_201 <= tmp_5_i_fu_144_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_i_reg_187 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                tmp_1_i_reg_206 <= tmp_1_i_fu_150_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_start = ap_const_logic_0) or (numReps_out_full_n = ap_const_logic_0) or (numReps_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    tmp_reg_182(31 downto 7) <= tmp_fu_121_p2(31 downto 7);
            end if;
        end if;
    end process;
    tmp_reg_182(6 downto 0) <= "0000000";

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, numReps_empty_n, numReps_out_full_n, ap_enable_reg_pp0_iter2, ap_enable_reg_pp0_iter3, exitcond_i_fu_127_p2, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_subdone)
    begin
        case ap_CS_fsm is
    ...
    begin
                ap_block_pp0_stage0_01001 <= (((exitcond_i_reg_187_pp0_iter2_reg = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1)) or ((in_V_V_empty_n = ap_const_logic_0) and (ap_predicate_op25_read_state4 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)));
    end process;
    ...
    begin
                ap_block_pp0_stage0_11001 <= (((exitcond_i_reg_187_pp0_iter2_reg = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1)) or ((in_V_V_empty_n = ap_const_logic_0) and (ap_predicate_op25_read_state4 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)));
    end process;
    ...
    begin
                ap_block_pp0_stage0_subdone <= (((exitcond_i_reg_187_pp0_iter2_reg = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1)) or ((in_V_V_empty_n = ap_const_logic_0) and (ap_predicate_op25_read_state4 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)));
    end process;
    ...
    begin
        if (((exitcond_i_reg_187 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
    ...
    ap_phi_mux_p_Val2_s_phi_fu_115_p4_assign_proc : process(ap_block_pp0_stage0, ap_enable_reg_pp0_iter3, exitcond_i_reg_187_pp0_iter2_reg, tmp_1_i_reg_206_pp0_iter2_reg, ap_phi_reg_pp0_iter3_p_Val2_s_reg_112, p_1_cast_i_fu_162_p1)
    begin
        if (((exitcond_i_reg_187_pp0_iter2_reg = ap_const_lv1_0) and (tmp_1_i_reg_206_pp0_iter2_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1))) then 
            ap_phi_mux_p_Val2_s_phi_fu_115_p4 <= p_1_cast_i_fu_162_p1;
        else 
    ...
    ap_predicate_op25_read_state4_assign_proc : process(exitcond_i_reg_187_pp0_iter1_reg, tmp_1_i_reg_206)
    begin
                ap_predicate_op25_read_state4 <= ((tmp_1_i_reg_206 = ap_const_lv1_1) and (exitcond_i_reg_187_pp0_iter1_reg = ap_const_lv1_0));
    end process;
    ...
    in_V_V_blk_n_assign_proc : process(in_V_V_empty_n, ap_enable_reg_pp0_iter2, ap_block_pp0_stage0, exitcond_i_reg_187_pp0_iter1_reg, tmp_1_i_reg_206)
    begin
        if (((tmp_1_i_reg_206 = ap_const_lv1_1) and (exitcond_i_reg_187_pp0_iter1_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
    ...
    out_V_V_din <= ap_phi_mux_p_Val2_s_phi_fu_115_p4(16 - 1 downto 0);
    ...
    p_1_cast_i_fu_162_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_1_i_reg_77),64));
    p_i_fu_156_p3 <= 
        ap_const_lv32_0 when (tmp_5_i_reg_201(0) = '1') else 
        o_reg_196;
    t_fu_132_p2 <= std_logic_vector(unsigned(t_i_reg_101) + unsigned(ap_const_lv32_1));
    tmp_1_i_fu_150_p2 <= "1" when (o_i_reg_89 = ap_const_lv32_0) else "0";
    tmp_5_i_fu_144_p2 <= "1" when (o_fu_138_p2 = ap_const_lv32_4) else "0";
    tmp_fu_121_p2 <= std_logic_vector(shift_left(unsigned(numReps_dout),to_integer(unsigned('0' & ap_const_lv32_7(31-1 downto 0)))));
end behav;
