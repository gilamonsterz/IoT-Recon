...
always @ (posedge ap_clk) begin
    if (((exitcond_i_reg_185_pp0_iter2_reg == 1'd0) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        p_4_i_reg_75 <= {{ap_phi_mux_p_Val2_s_phi_fu_113_p4[63:1]}};
    end else if ((~((ap_start == 1'b0) | (numReps_out_full_n == 1'b0) | (numReps_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        p_4_i_reg_75 <= 63'd0;
    end
end
...
assign out_V_V_din = ap_phi_mux_p_Val2_s_phi_fu_113_p4[0:0];

assign p_4_cast_i_fu_160_p1 = p_4_i_reg_75;

assign p_i_fu_154_p3 = ((tmp_8_i_reg_199[0:0] === 1'b1) ? 32'd0 : o_reg_194);

assign t_fu_130_p2 = (t_i_reg_99 + 32'd1);

assign tmp_8_i_fu_142_p2 = ((o_fu_136_p2 == 32'd64) ? 1'b1 : 1'b0);
