...
architecture behav of StreamingDataWidthCo_3 is 
    ...
    signal tmp_i_1022_fu_139_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_i_1022_reg_201 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal grp_fu_117_p1 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    component BBJ_u96_cnvW2A2_mkbM IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    BBJ_u96_cnvW2A2_mkbM_U104 : component BBJ_u96_cnvW2A2_mkbM
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    grp_fu_117_p1 <= ap_const_lv32_E10(13 - 1 downto 0);
    ...
    p_i_fu_151_p3 <= 
        ap_const_lv32_0 when (tmp_i_1022_reg_201(0) = '1') else 
        o_reg_196;
    ...
    tmp_i_1022_fu_139_p2 <= "1" when (o_fu_133_p2 = ap_const_lv32_2) else "0";
