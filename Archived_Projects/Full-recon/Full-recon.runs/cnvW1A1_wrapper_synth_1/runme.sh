...
HD_PWD='D:/Adam/Documents/Vivado_Projects/IoT-Redeaux/Full-recon/Full-recon.runs/cnvW1A1_wrapper_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cnvW1A1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cnvW1A1_wrapper.tcl
