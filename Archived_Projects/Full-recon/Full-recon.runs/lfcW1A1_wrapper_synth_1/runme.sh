...
HD_PWD='D:/Adam/Documents/Vivado_Projects/IoT-Redeaux/Full-recon/Full-recon.runs/lfcW1A1_wrapper_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lfcW1A1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lfcW1A1_wrapper.tcl
