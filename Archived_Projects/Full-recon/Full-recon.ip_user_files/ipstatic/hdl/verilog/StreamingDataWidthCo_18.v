...
reg   [31:0] o_reg_198;
wire   [0:0] tmp_i_1026_fu_141_p2;
reg   [0:0] tmp_i_1026_reg_203;
...
wire   [127:0] p_9_cast_i_fu_159_p1;
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_reg_189_pp0_iter2_reg == 1'd0) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        p_9_i_reg_75 <= {{ap_phi_mux_p_Val2_s_phi_fu_113_p4[127:64]}};
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        p_9_i_reg_75 <= 64'd0;
    end
end
...
assign p_9_cast_i_fu_159_p1 = p_9_i_reg_75;

assign p_i_fu_153_p3 = ((tmp_i_1026_reg_203[0:0] === 1'b1) ? 32'd0 : o_reg_198);

assign start_out = real_start;

assign t_fu_129_p2 = (t_i_reg_99 + 32'd1);

assign tmp_i_1026_fu_141_p2 = ((o_fu_135_p2 == 32'd2) ? 1'b1 : 1'b0);
