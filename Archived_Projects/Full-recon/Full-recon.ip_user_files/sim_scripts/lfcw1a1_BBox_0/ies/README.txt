...
#
# Generated by export_simulation on Wed Dec 25 14:54:14 -0600 2019
#
################################################################################
...
'-reset_run' switch to the './lfcw1a1_BBox_0.sh' script.

./lfcw1a1_BBox_0.sh -reset_run
...
./lfcw1a1_BBox_0.sh -noclean_files

For more information on the script, please type './lfcw1a1_BBox_0.sh -help'.
