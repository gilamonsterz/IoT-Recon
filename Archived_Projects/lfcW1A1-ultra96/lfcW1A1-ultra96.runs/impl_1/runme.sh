...
HD_PWD='D:/Adam/Documents/Vivado_Projects/FINN-PreRecon/lfcW1A1-ultra96/lfcW1A1-ultra96.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log super_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source super_wrapper.tcl -notrace
