...
wire   [61:0] phitmp_cast_i_fu_167_p3;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state2;
reg    ap_block_pp0_stage0_01001;
reg   [31:0] i_3_fu_52;
wire   [31:0] i_fu_131_p2;
wire   [59:0] tmp_9_fu_157_p4;
...
always @ (posedge ap_clk) begin
    if ((~((real_start == 1'b0) | (numReps_out_full_n == 1'b0) | (numReps_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        tmp_reg_182[31 : 9] <= tmp_fu_111_p2[31 : 9];
    end
end
...
assign i_fu_131_p2 = (i_3_fu_52 + 32'd1);

assign numReps_out_din = numReps_dout;

assign out_V_V_din = {{in_V_V_dout}, {r_V_reg_83}};

assign phitmp_cast_i_fu_167_p3 = {{in_V_V_dout}, {tmp_9_fu_157_p4}};

assign start_out = real_start;

assign t_fu_122_p2 = (t_i_reg_95 + 32'd1);

assign tmp_9_fu_157_p4 = {{r_V_reg_83[61:2]}};

assign tmp_fu_111_p2 = numReps_dout << 32'd9;

assign tmp_i_fu_137_p2 = ((i_fu_131_p2 == 32'd32) ? 1'b1 : 1'b0);

always @ (posedge ap_clk) begin
    tmp_reg_182[8:0] <= 9'b000000000;
end
