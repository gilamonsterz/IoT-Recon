...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_i_fu_117_p2 == 1'd0) & (tmp_i_fu_137_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_1_fu_52 <= i_fu_131_p2;
    end else if ((((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_fu_137_p2 == 1'd1) & (exitcond_i_fu_117_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | (~((ap_start == 1'b0) | (numReps_out_full_n == 1'b0) | (numReps_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1)))) begin
        i_1_fu_52 <= 32'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_i_reg_187 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_i_fu_117_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_i_fu_117_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_reg_196 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        out_V_V_write = 1'b1;
    end else begin
        out_V_V_write = 1'b0;
    end
...
assign i_fu_131_p2 = (i_1_fu_52 + 32'd1);

assign numReps_out_din = numReps_dout;

assign out_V_V_din = {{in_V_V_dout}, {r_V_reg_83}};

assign phitmp_cast_i_fu_167_p3 = {{in_V_V_dout}, {tmp_2_fu_157_p4}};

assign t_fu_122_p2 = (t_i_reg_95 + 32'd1);

assign tmp_2_fu_157_p4 = {{r_V_reg_83[47:16]}};

assign tmp_fu_111_p2 = numReps_dout << 32'd2;

assign tmp_i_fu_137_p2 = ((i_fu_131_p2 == 32'd4) ? 1'b1 : 1'b0);
