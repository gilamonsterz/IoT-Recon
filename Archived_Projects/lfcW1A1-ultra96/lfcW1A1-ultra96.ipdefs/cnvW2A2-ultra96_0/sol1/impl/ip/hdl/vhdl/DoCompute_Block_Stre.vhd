...
architecture behav of DoCompute_Block_Stre is 
    ...
    signal tmp_71_i_reg_45 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    component BBJ_u96_cnvW2A2_mbGp IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    BBJ_u96_cnvW2A2_mbGp_U642 : component BBJ_u96_cnvW2A2_mbGp
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((tmp_71_out_out_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state7))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, numReps_empty_n, tmp_71_out_out_full_n, ap_CS_fsm_state7)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state7 => 
                if (((tmp_71_out_out_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state7))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state7;
                end if;
    ...
    ap_done_assign_proc : process(ap_done_reg, tmp_71_out_out_full_n, ap_CS_fsm_state7)
    begin
        if (((tmp_71_out_out_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state7))) then 
    ...
    ap_ready_assign_proc : process(tmp_71_out_out_full_n, ap_CS_fsm_state7)
    begin
        if (((tmp_71_out_out_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state7))) then 
    ...
    tmp_71_out_out_blk_n_assign_proc : process(tmp_71_out_out_full_n, ap_CS_fsm_state7)
    begin
    ...
    tmp_71_out_out_din <= tmp_71_i_reg_45;

    tmp_71_out_out_write_assign_proc : process(tmp_71_out_out_full_n, ap_CS_fsm_state7)
    begin
        if (((tmp_71_out_out_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state7))) then 
