...
architecture behav of DoCompute_Block_Stre_2 is 
    ...
    signal tmp_72_out_out_blk_n : STD_LOGIC;
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((tmp_72_out_out_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, numReps_empty_n, tmp_72_out_out_full_n, ap_CS_fsm_state2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((tmp_72_out_out_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state2;
                end if;
    ...
    ap_done_assign_proc : process(ap_done_reg, tmp_72_out_out_full_n, ap_CS_fsm_state2)
    begin
        if (((tmp_72_out_out_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ap_ready_assign_proc : process(tmp_72_out_out_full_n, ap_CS_fsm_state2)
    begin
        if (((tmp_72_out_out_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    tmp_72_out_out_blk_n_assign_proc : process(tmp_72_out_out_full_n, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            tmp_72_out_out_blk_n <= tmp_72_out_out_full_n;
        else 
            tmp_72_out_out_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    tmp_72_out_out_din <= std_logic_vector(unsigned(numReps_read_reg_46) + unsigned(tmp_fu_35_p2));

    tmp_72_out_out_write_assign_proc : process(tmp_72_out_out_full_n, ap_CS_fsm_state2)
    begin
        if (((tmp_72_out_out_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            tmp_72_out_out_write <= ap_const_logic_1;
        else 
            tmp_72_out_out_write <= ap_const_logic_0;
        end if; 
    end process;
