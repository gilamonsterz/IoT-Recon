...
module StreamingDataWidthCo_21 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg   [31:0] o_reg_198;
wire   [0:0] tmp_i_1023_fu_141_p2;
reg   [0:0] tmp_i_1023_reg_203;
...
wire   [127:0] p_2_cast_i_fu_159_p1;
...
BBJ_u96_cnvW2A2_mbwn #(
    .ID( 1 ),
    .NUM_STAGE( 5 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 10 ),
    .dout_WIDTH( 32 ))
BBJ_u96_cnvW2A2_mbwn_U827(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_reg_189_pp0_iter2_reg == 1'd0) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        p_2_i_reg_75 <= {{ap_phi_mux_p_Val2_s_phi_fu_113_p4[127:16]}};
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        p_2_i_reg_75 <= 112'd0;
    end
end
...
assign p_2_cast_i_fu_159_p1 = p_2_i_reg_75;

assign p_i_fu_153_p3 = ((tmp_i_1023_reg_203[0:0] === 1'b1) ? 32'd0 : o_reg_198);

assign start_out = real_start;

assign t_fu_129_p2 = (t_i_reg_99 + 32'd1);

assign tmp_i_1023_fu_141_p2 = ((o_fu_135_p2 == 32'd8) ? 1'b1 : 1'b0);

assign tmp_i_fu_147_p2 = ((o_i_reg_87 == 32'd0) ? 1'b1 : 1'b0);

endmodule //StreamingDataWidthCo_21
