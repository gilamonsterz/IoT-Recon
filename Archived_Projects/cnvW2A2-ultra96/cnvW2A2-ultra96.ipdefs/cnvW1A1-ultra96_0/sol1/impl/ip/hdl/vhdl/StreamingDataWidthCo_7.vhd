...
architecture behav of StreamingDataWidthCo_7 is 
    ...
    signal tmp_9_i_fu_144_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_9_i_reg_201 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal p_5_cast_i_fu_162_p1 : STD_LOGIC_VECTOR (255 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_i_reg_187_pp0_iter2_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                p_5_i_reg_77 <= ap_phi_mux_p_Val2_s_phi_fu_115_p4(255 downto 4);
            elsif ((not(((ap_start = ap_const_logic_0) or (numReps_out_full_n = ap_const_logic_0) or (numReps_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_i_fu_127_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                ...
                tmp_9_i_reg_201 <= tmp_9_i_fu_144_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_phi_mux_p_Val2_s_phi_fu_115_p4_assign_proc : process(ap_block_pp0_stage0, ap_enable_reg_pp0_iter3, exitcond_i_reg_187_pp0_iter2_reg, tmp_i_reg_206_pp0_iter2_reg, ap_phi_reg_pp0_iter3_p_Val2_s_reg_112, p_5_cast_i_fu_162_p1)
    begin
        if (((exitcond_i_reg_187_pp0_iter2_reg = ap_const_lv1_0) and (tmp_i_reg_206_pp0_iter2_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1))) then 
            ap_phi_mux_p_Val2_s_phi_fu_115_p4 <= p_5_cast_i_fu_162_p1;
        else 
    ...
    out_V_V_din <= ap_phi_mux_p_Val2_s_phi_fu_115_p4(4 - 1 downto 0);
    ...
    p_5_cast_i_fu_162_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_5_i_reg_77),256));
    p_i_fu_156_p3 <= 
        ap_const_lv32_0 when (tmp_9_i_reg_201(0) = '1') else 
        o_reg_196;
    t_fu_132_p2 <= std_logic_vector(unsigned(t_i_reg_101) + unsigned(ap_const_lv32_1));
    tmp_9_i_fu_144_p2 <= "1" when (o_fu_138_p2 = ap_const_lv32_40) else "0";
