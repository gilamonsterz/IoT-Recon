...
reg   [31:0] o_reg_196;
wire   [0:0] tmp_i_1024_fu_139_p2;
reg   [0:0] tmp_i_1024_reg_201;
...
wire   [63:0] p_2_cast_i_fu_157_p1;
reg    ap_block_pp0_stage0_01001;
wire   [10:0] grp_fu_117_p1;
...
BBJ_u96_cnvW2A2_mg8j #(
    .ID( 1 ),
    .NUM_STAGE( 5 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 11 ),
    .dout_WIDTH( 32 ))
BBJ_u96_cnvW2A2_mg8j_U456(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_reg_187_pp0_iter2_reg == 1'd0) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        p_2_i_reg_73 <= {{ap_phi_mux_p_Val2_s_phi_fu_111_p4[63:32]}};
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        p_2_i_reg_73 <= 32'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_122_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        tmp_i_1024_reg_201 <= tmp_i_1024_fu_139_p2;
    end
end
...
assign p_2_cast_i_fu_157_p1 = p_2_i_reg_73;

assign p_i_fu_151_p3 = ((tmp_i_1024_reg_201[0:0] === 1'b1) ? 32'd0 : o_reg_196);

assign start_out = real_start;

assign t_fu_127_p2 = (t_i_reg_97 + 32'd1);

assign tmp_i_1024_fu_139_p2 = ((o_fu_133_p2 == 32'd2) ? 1'b1 : 1'b0);
