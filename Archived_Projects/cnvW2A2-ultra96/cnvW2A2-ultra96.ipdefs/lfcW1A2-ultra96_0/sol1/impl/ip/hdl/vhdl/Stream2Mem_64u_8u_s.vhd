...
architecture behav of Stream2Mem_64u_8u_s is 
    ...
    signal sum_fu_96_p2 : STD_LOGIC_VECTOR (61 downto 0);
    signal sum_reg_112 : STD_LOGIC_VECTOR (61 downto 0);
    signal tmp_V_reg_123 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal sum_cast_fu_102_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_reg_ioackin_m_axi_out_V_AWREADY : STD_LOGIC := '0';
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal ap_reg_ioackin_m_axi_out_V_WREADY : STD_LOGIC := '0';
    signal out_V_offset_cast3_fu_92_p1 : STD_LOGIC_VECTOR (61 downto 0);
    signal out_V_offset_cast_ca_fu_88_p1 : STD_LOGIC_VECTOR (61 downto 0);
...
begin
            ...
            if (ap_rst = '1') then
                ...
                if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                    if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then 
                        ap_reg_ioackin_m_axi_out_V_AWREADY <= ap_const_logic_0;
                    elsif (((m_axi_out_V_AWREADY = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_01001))) then 
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter7, in_V_V_empty_n, m_axi_out_V_BVALID)
    begin
                ap_block_pp0_stage0_01001 <= (((ap_start = ap_const_logic_0) and (ap_start = ap_const_logic_1)) or ((in_V_V_empty_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((m_axi_out_V_BVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter7 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, ap_enable_reg_pp0_iter7, in_V_V_empty_n, m_axi_out_V_BVALID, ap_sig_ioackin_m_axi_out_V_AWREADY, ap_sig_ioackin_m_axi_out_V_WREADY)
    begin
                ap_block_pp0_stage0_11001 <= (((ap_start = ap_const_logic_0) and (ap_start = ap_const_logic_1)) or ((m_axi_out_V_BVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter7 = ap_const_logic_1)) or ((ap_sig_ioackin_m_axi_out_V_WREADY = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((in_V_V_empty_n = ap_const_logic_0) or (ap_sig_ioackin_m_axi_out_V_AWREADY = ap_const_logic_0))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, ap_enable_reg_pp0_iter7, in_V_V_empty_n, m_axi_out_V_BVALID, ap_sig_ioackin_m_axi_out_V_AWREADY, ap_sig_ioackin_m_axi_out_V_WREADY)
    begin
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(in_V_V_empty_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= (in_V_V_empty_n = ap_const_logic_0);
    end process;
    ...
    in_V_V_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_enable_reg_pp0_iter1, in_V_V_empty_n)
    begin
    ...
    m_axi_out_V_AWADDR <= sum_cast_fu_102_p1;
    ...
    m_axi_out_V_AWVALID_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_reg_ioackin_m_axi_out_V_AWREADY, ap_block_pp0_stage0_01001)
    begin
        if (((ap_reg_ioackin_m_axi_out_V_AWREADY = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_01001))) then 
    ...
    m_axi_out_V_WDATA <= tmp_V_reg_123;
    ...
    m_axi_out_V_WVALID_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_01001, ap_reg_ioackin_m_axi_out_V_WREADY)
    begin
        if (((ap_reg_ioackin_m_axi_out_V_WREADY = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_01001))) then 
    ...
    out_V_offset_cast3_fu_92_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(out_V_offset),62));
    out_V_offset_cast_ca_fu_88_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(out_V_offset1),62));
    sum_cast_fu_102_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum_reg_112),64));
    sum_fu_96_p2 <= std_logic_vector(unsigned(out_V_offset_cast3_fu_92_p1) + unsigned(out_V_offset_cast_ca_fu_88_p1));
end behav;
