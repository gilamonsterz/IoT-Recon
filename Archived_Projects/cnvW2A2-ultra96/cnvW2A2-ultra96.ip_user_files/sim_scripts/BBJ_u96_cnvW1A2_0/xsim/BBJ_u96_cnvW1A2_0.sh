...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot BBJ_u96_cnvW1A2_0 xil_defaultlib.BBJ_u96_cnvW1A2_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim BBJ_u96_cnvW1A2_0 -key {Behavioral:sim_1:Functional:BBJ_u96_cnvW1A2_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb BBJ_u96_cnvW1A2_0.wdb xsim.dir)
