...
input  [31:0] numReps_c22_dout;
input   numReps_c22_empty_n;
output   numReps_c22_read;
...
reg    numReps_c22_blk_n;
reg   [60:0] out_V_offset_read_reg_135;
reg    ap_block_state1;
reg   [31:0] numReps_c22_read_reg_141;
...
reg    grp_Stream2Mem_64u_8u_s_fu_68_ap_start_reg;
reg   [10:0] ap_NS_fsm;
...
#0 grp_Stream2Mem_64u_8u_s_fu_68_ap_start_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (tmp_i_i_i_fu_87_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_Stream2Mem_64u_8u_s_fu_68_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_NS_fsm_state3) & (1'b1 == ap_CS_fsm_state2))) begin
            grp_Stream2Mem_64u_8u_s_fu_68_ap_start_reg <= 1'b1;
        end else if ((grp_Stream2Mem_64u_8u_s_fu_68_ap_ready == 1'b1)) begin
            grp_Stream2Mem_64u_8u_s_fu_68_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((tmp_i_i_i_fu_87_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2) & (tmp_1_i_i_i_fu_101_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state11) & (grp_Stream2Mem_fu_58_ap_done == 1'b1))) begin
        rep_fu_42 <= rep_1_fu_117_p2;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        rep_fu_42 <= rep_2_fu_107_p2;
    end else if ((~((numReps_c22_empty_n == 1'b0) | (out_V_offset_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        rep_fu_42 <= 32'd0;
    end
end

always @ (posedge ap_clk) begin
    if ((~((numReps_c22_empty_n == 1'b0) | (out_V_offset_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_i_i_i_fu_87_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_1_i_i_i_reg_158 <= tmp_1_i_i_i_fu_101_p2;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (tmp_i_i_i_fu_87_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state5) | (1'b1 == ap_CS_fsm_state4) | ((tmp_1_i_i_i_reg_158 == 1'd0) & (1'b1 == ap_CS_fsm_state10)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state8) | (1'b1 == ap_CS_fsm_state7) | (1'b1 == ap_CS_fsm_state6) | (1'b1 == ap_CS_fsm_state3) | (1'b1 == ap_CS_fsm_state5) | (1'b1 == ap_CS_fsm_state4) | ((tmp_1_i_i_i_reg_158 == 1'd0) & (1'b1 == ap_CS_fsm_state10)))) begin
        m_axi_in_V_AWADDR = grp_Stream2Mem_64u_8u_s_fu_68_m_axi_out_V_AWADDR;
    end else if (((1'b1 == ap_CS_fsm_state11) | ((tmp_i_i_i_fu_87_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2) & (tmp_1_i_i_i_fu_101_p2 == 1'd1)))) begin
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        numReps_c22_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((numReps_c22_empty_n == 1'b0) | (out_V_offset_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        numReps_c22_read = 1'b1;
    end else begin
        numReps_c22_read = 1'b0;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b1 == ap_CS_fsm_state2) & (tmp_i_i_i_fu_87_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if (((tmp_i_i_i_fu_87_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2) & (tmp_1_i_i_i_fu_101_p2 == 1'd1))) begin
        ...
        ap_ST_fsm_state4 : begin
            if ((~(((grp_Stream2Mem_64u_8u_s_fu_68_out_V_blk_n_W & grp_Stream2Mem_64u_8u_s_fu_68_out_V_blk_n_B & grp_Stream2Mem_64u_8u_s_fu_68_out_V_blk_n_AW) == 1'b0) | (grp_Stream2Mem_64u_8u_s_fu_68_in_V_V_blk_n == 1'b0)) & (1'b1 == ap_CS_fsm_state4))) begin
        ...
        ap_ST_fsm_state5 : begin
            if ((~(((grp_Stream2Mem_64u_8u_s_fu_68_out_V_blk_n_W & grp_Stream2Mem_64u_8u_s_fu_68_out_V_blk_n_B & grp_Stream2Mem_64u_8u_s_fu_68_out_V_blk_n_AW) == 1'b0) | (grp_Stream2Mem_64u_8u_s_fu_68_in_V_V_blk_n == 1'b0)) & (1'b1 == ap_CS_fsm_state5))) begin
        ...
        ap_ST_fsm_state10 : begin
            if ((~((tmp_1_i_i_i_reg_158 == 1'd0) & (((grp_Stream2Mem_64u_8u_s_fu_68_out_V_blk_n_W & grp_Stream2Mem_64u_8u_s_fu_68_out_V_blk_n_B & grp_Stream2Mem_64u_8u_s_fu_68_out_V_blk_n_AW) == 1'b0) | (grp_Stream2Mem_64u_8u_s_fu_68_in_V_V_blk_n == 1'b0))) & (1'b1 == ap_CS_fsm_state10))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state10;
            end
...
always @ (*) begin
    ap_block_state1 = ((numReps_c22_empty_n == 1'b0) | (out_V_offset_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1));
end

always @ (*) begin
    ap_block_state10 = ((tmp_1_i_i_i_reg_158 == 1'd0) & (((grp_Stream2Mem_64u_8u_s_fu_68_out_V_blk_n_W & grp_Stream2Mem_64u_8u_s_fu_68_out_V_blk_n_B & grp_Stream2Mem_64u_8u_s_fu_68_out_V_blk_n_AW) == 1'b0) | (grp_Stream2Mem_64u_8u_s_fu_68_in_V_V_blk_n == 1'b0)));
end

always @ (*) begin
    ap_block_state4 = (((grp_Stream2Mem_64u_8u_s_fu_68_out_V_blk_n_W & grp_Stream2Mem_64u_8u_s_fu_68_out_V_blk_n_B & grp_Stream2Mem_64u_8u_s_fu_68_out_V_blk_n_AW) == 1'b0) | (grp_Stream2Mem_64u_8u_s_fu_68_in_V_V_blk_n == 1'b0));
end

always @ (*) begin
    ap_block_state5 = (((grp_Stream2Mem_64u_8u_s_fu_68_out_V_blk_n_W & grp_Stream2Mem_64u_8u_s_fu_68_out_V_blk_n_B & grp_Stream2Mem_64u_8u_s_fu_68_out_V_blk_n_AW) == 1'b0) | (grp_Stream2Mem_64u_8u_s_fu_68_in_V_V_blk_n == 1'b0));
end

assign grp_Stream2Mem_64u_8u_s_fu_68_ap_start = grp_Stream2Mem_64u_8u_s_fu_68_ap_start_reg;
...
assign rep_1_fu_117_p2 = (rep_load_reg_147 + 32'd16);

assign rep_2_fu_107_p2 = (rep_load_reg_147 + 32'd1);

assign repsLeft_fu_92_p2 = (numReps_c22_read_reg_141 - rep_fu_42);

assign tmp_1_i_i_i_fu_101_p2 = ((tmp_fu_97_p1 == 4'd0) ? 1'b1 : 1'b0);

assign tmp_fu_97_p1 = repsLeft_fu_92_p2[3:0];

assign tmp_i_i_i_fu_87_p2 = ((rep_fu_42 == numReps_c22_read_reg_141) ? 1'b1 : 1'b0);
