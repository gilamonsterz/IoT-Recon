...
reg   [31:0] o_reg_196;
wire   [0:0] tmp_5_i_fu_144_p2;
reg   [0:0] tmp_5_i_reg_201;
wire   [0:0] tmp_1_i_fu_150_p2;
reg   [0:0] tmp_1_i_reg_206_pp0_iter2_reg;
...
wire   [63:0] p_1_cast_i_fu_162_p1;
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((tmp_1_i_reg_206 == 1'd1) & (exitcond_i_reg_187_pp0_iter1_reg == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_reg_187_pp0_iter2_reg == 1'd0) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        p_1_i_reg_77 <= {{ap_phi_mux_p_Val2_s_phi_fu_115_p4[63:16]}};
    end else if ((~((ap_start == 1'b0) | (numReps_out_full_n == 1'b0) | (numReps_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        p_1_i_reg_77 <= 48'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((ap_start == 1'b0) | (numReps_out_full_n == 1'b0) | (numReps_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        tmp_reg_182[31 : 7] <= tmp_fu_121_p2[31 : 7];
    end
end
...
always @ (*) begin
    if (((exitcond_i_reg_187_pp0_iter2_reg == 1'd0) & (tmp_1_i_reg_206_pp0_iter2_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter3 == 1'b1))) begin
...
always @ (*) begin
    if (((tmp_1_i_reg_206 == 1'd1) & (exitcond_i_reg_187_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    ap_predicate_op25_read_state4 = ((tmp_1_i_reg_206 == 1'd1) & (exitcond_i_reg_187_pp0_iter1_reg == 1'd0));
end
...
assign out_V_V_din = ap_phi_mux_p_Val2_s_phi_fu_115_p4[15:0];

assign p_1_cast_i_fu_162_p1 = p_1_i_reg_77;

assign p_i_fu_156_p3 = ((tmp_5_i_reg_201[0:0] === 1'b1) ? 32'd0 : o_reg_196);

assign t_fu_132_p2 = (t_i_reg_101 + 32'd1);

assign tmp_1_i_fu_150_p2 = ((o_i_reg_89 == 32'd0) ? 1'b1 : 1'b0);

assign tmp_5_i_fu_144_p2 = ((o_fu_138_p2 == 32'd4) ? 1'b1 : 1'b0);

assign tmp_fu_121_p2 = numReps_dout << 32'd7;

always @ (posedge ap_clk) begin
    tmp_reg_182[6:0] <= 7'b0000000;
end
