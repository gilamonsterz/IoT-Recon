...
reg   [31:0] o_reg_196;
wire   [0:0] tmp_i_340_fu_139_p2;
reg   [0:0] tmp_i_340_reg_201;
...
BBJ_u96_cnvW1A1_msc4 #(
    .ID( 1 ),
    .NUM_STAGE( 5 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 10 ),
    .dout_WIDTH( 32 ))
BBJ_u96_cnvW1A1_msc4_U186(
    .clk(ap_clk),
    .reset(ap_rst),
...
assign p_i_fu_151_p3 = ((tmp_i_340_reg_201[0:0] === 1'b1) ? 32'd0 : o_reg_196);

assign start_out = real_start;

assign t_fu_127_p2 = (t_i_reg_97 + 32'd1);

assign tmp_i_340_fu_139_p2 = ((o_fu_133_p2 == 32'd2) ? 1'b1 : 1'b0);
