...
architecture behav of StreamingDataWidthCo_14 is 
    ...
    signal p_6_i_reg_77 : STD_LOGIC_VECTOR (167 downto 0);
    ...
    signal tmp_14_i_fu_144_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_14_i_reg_201 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal p_6_cast_i_fu_162_p1 : STD_LOGIC_VECTOR (191 downto 0);
...
begin
    ...
    p_6_i_reg_77_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_i_reg_187_pp0_iter2_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                p_6_i_reg_77 <= ap_phi_mux_p_Val2_s_phi_fu_115_p4(191 downto 24);
            elsif ((not(((real_start = ap_const_logic_0) or (numReps_out_full_n = ap_const_logic_0) or (numReps_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                p_6_i_reg_77 <= ap_const_lv168_lc_1;
            end if; 
        end if;
    end process;
    ...
    ap_phi_mux_p_Val2_s_phi_fu_115_p4_assign_proc : process(ap_block_pp0_stage0, ap_enable_reg_pp0_iter3, exitcond_i_reg_187_pp0_iter2_reg, tmp_i_reg_206_pp0_iter2_reg, ap_phi_reg_pp0_iter3_p_Val2_s_reg_112, p_6_cast_i_fu_162_p1)
    begin
        if (((exitcond_i_reg_187_pp0_iter2_reg = ap_const_lv1_0) and (tmp_i_reg_206_pp0_iter2_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1))) then 
            ap_phi_mux_p_Val2_s_phi_fu_115_p4 <= p_6_cast_i_fu_162_p1;
        else 
    ...
    p_6_cast_i_fu_162_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_6_i_reg_77),192));
    p_i_fu_156_p3 <= 
        ap_const_lv32_0 when (tmp_14_i_reg_201(0) = '1') else 
        o_reg_196;
    ...
    tmp_14_i_fu_144_p2 <= "1" when (o_fu_138_p2 = ap_const_lv32_8) else "0";
