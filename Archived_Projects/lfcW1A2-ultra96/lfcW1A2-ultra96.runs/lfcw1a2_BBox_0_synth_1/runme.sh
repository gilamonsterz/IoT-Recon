...
HD_PWD='D:/Adam/Documents/Vivado_Projects/FINN-PreRecon/lfcW1A2-ultra96/lfcW1A2-ultra96.runs/lfcw1a2_BBox_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lfcw1a2_BBox_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lfcw1a2_BBox_0.tcl
