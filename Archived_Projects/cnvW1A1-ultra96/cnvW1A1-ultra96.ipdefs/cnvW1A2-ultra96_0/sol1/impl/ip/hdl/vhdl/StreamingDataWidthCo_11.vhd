...
architecture behav of StreamingDataWidthCo_11 is 
    ...
    signal p_3_i_reg_77 : STD_LOGIC_VECTOR (247 downto 0);
    ...
    signal tmp_13_i_fu_144_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_13_i_reg_201 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal ap_phi_mux_p_Val2_s_phi_fu_115_p4 : STD_LOGIC_VECTOR (255 downto 0);
    signal ap_phi_reg_pp0_iter0_p_Val2_s_reg_112 : STD_LOGIC_VECTOR (255 downto 0);
    signal ap_phi_reg_pp0_iter1_p_Val2_s_reg_112 : STD_LOGIC_VECTOR (255 downto 0);
    signal ap_phi_reg_pp0_iter2_p_Val2_s_reg_112 : STD_LOGIC_VECTOR (255 downto 0);
    signal ap_phi_reg_pp0_iter3_p_Val2_s_reg_112 : STD_LOGIC_VECTOR (255 downto 0);
    signal p_3_cast_i_fu_162_p1 : STD_LOGIC_VECTOR (255 downto 0);
...
begin
    ...
    p_3_i_reg_77_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_i_reg_187_pp0_iter2_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                p_3_i_reg_77 <= ap_phi_mux_p_Val2_s_phi_fu_115_p4(255 downto 8);
            elsif ((not(((ap_start = ap_const_logic_0) or (numReps_out_full_n = ap_const_logic_0) or (numReps_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                p_3_i_reg_77 <= ap_const_lv248_lc_1;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_start = ap_const_logic_0) or (numReps_out_full_n = ap_const_logic_0) or (numReps_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    tmp_reg_182(31 downto 6) <= tmp_fu_121_p2(31 downto 6);
            end if;
        end if;
    end process;
    tmp_reg_182(5 downto 0) <= "000000";
    ...
    ap_phi_mux_p_Val2_s_phi_fu_115_p4_assign_proc : process(ap_block_pp0_stage0, ap_enable_reg_pp0_iter3, exitcond_i_reg_187_pp0_iter2_reg, tmp_i_reg_206_pp0_iter2_reg, ap_phi_reg_pp0_iter3_p_Val2_s_reg_112, p_3_cast_i_fu_162_p1)
    begin
    ...
    ap_phi_reg_pp0_iter0_p_Val2_s_reg_112 <= "";
    ...
    p_3_cast_i_fu_162_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_3_i_reg_77),256));
    p_i_fu_156_p3 <= 
        ap_const_lv32_0 when (tmp_13_i_reg_201(0) = '1') else 
        o_reg_196;
    t_fu_132_p2 <= std_logic_vector(unsigned(t_i_reg_101) + unsigned(ap_const_lv32_1));
    tmp_13_i_fu_144_p2 <= "1" when (o_fu_138_p2 = ap_const_lv32_20) else "0";
    tmp_fu_121_p2 <= std_logic_vector(shift_left(unsigned(numReps_dout),to_integer(unsigned('0' & ap_const_lv32_6(31-1 downto 0)))));
