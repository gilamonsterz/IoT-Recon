...
architecture behav of StreamingDataWidthCo_5 is 
    ...
    signal i_6_fu_42 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_fu_120_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_101_p1 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    component BBJ_u96_cnvW1A2_mibs IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    BBJ_u96_cnvW1A2_mibs_U97 : component BBJ_u96_cnvW1A2_mibs
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    grp_fu_101_p1 <= ap_const_lv32_E10(13 - 1 downto 0);
    i_fu_120_p2 <= std_logic_vector(unsigned(i_6_fu_42) + unsigned(ap_const_lv32_1));
