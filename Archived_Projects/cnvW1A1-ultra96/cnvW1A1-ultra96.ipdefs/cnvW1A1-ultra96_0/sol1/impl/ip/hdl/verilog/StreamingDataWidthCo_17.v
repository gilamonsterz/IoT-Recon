...
reg   [31:0] o_reg_210;
wire   [0:0] tmp_i_341_fu_158_p2;
reg   [0:0] tmp_i_341_reg_215;
...
wire   [127:0] p_9_cast_i_fu_176_p1;
reg    ap_block_pp0_stage0_01001;
wire   [31:0] tmp_fu_123_p2;
wire   [31:0] tmp_9_fu_129_p2;
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_reg_201_pp0_iter2_reg == 1'd0) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        p_9_i_reg_79 <= {{ap_phi_mux_p_Val2_s_phi_fu_117_p4[127:32]}};
    end else if ((~((real_start == 1'b0) | (numReps_out_full_n == 1'b0) | (numReps_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        p_9_i_reg_79 <= 96'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((real_start == 1'b0) | (numReps_out_full_n == 1'b0) | (numReps_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        totalIters_reg_196[31 : 6] <= totalIters_fu_135_p2[31 : 6];
    end
end
...
assign p_9_cast_i_fu_176_p1 = p_9_i_reg_79;

assign p_i_fu_170_p3 = ((tmp_i_341_reg_215[0:0] === 1'b1) ? 32'd0 : o_reg_210);

assign start_out = real_start;

assign t_fu_146_p2 = (t_i_reg_103 + 32'd1);

assign tmp_9_fu_129_p2 = numReps_dout << 32'd6;

assign tmp_fu_123_p2 = numReps_dout << 32'd9;

assign tmp_i_341_fu_158_p2 = ((o_fu_152_p2 == 32'd4) ? 1'b1 : 1'b0);

assign tmp_i_fu_164_p2 = ((o_i_reg_91 == 32'd0) ? 1'b1 : 1'b0);

assign totalIters_fu_135_p2 = (tmp_fu_123_p2 + tmp_9_fu_129_p2);

always @ (posedge ap_clk) begin
    totalIters_reg_196[5:0] <= 6'b000000;
end
