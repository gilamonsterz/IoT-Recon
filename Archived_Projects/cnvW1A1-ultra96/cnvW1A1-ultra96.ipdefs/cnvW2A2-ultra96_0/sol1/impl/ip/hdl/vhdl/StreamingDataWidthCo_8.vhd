...
architecture behav of StreamingDataWidthCo_8 is 
    ...
    signal i_3_fu_42 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    BBJ_u96_cnvW2A2_mkbM_U432 : component BBJ_u96_cnvW2A2_mkbM
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    grp_fu_101_p1 <= ap_const_lv32_C40(13 - 1 downto 0);
    i_fu_120_p2 <= std_logic_vector(unsigned(i_3_fu_42) + unsigned(ap_const_lv32_1));
