...
wire   [191:0] p_7_cast_i_fu_162_p1;
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_reg_187_pp0_iter2_reg == 1'd0) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        p_7_i_reg_77 <= {{ap_phi_mux_p_Val2_s_phi_fu_115_p4[191:24]}};
    end else if ((~((real_start == 1'b0) | (numReps_out_full_n == 1'b0) | (numReps_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        p_7_i_reg_77 <= 168'd0;
    end
end
...
assign p_7_cast_i_fu_162_p1 = p_7_i_reg_77;

assign p_i_fu_156_p3 = ((tmp_10_i_reg_201[0:0] === 1'b1) ? 32'd0 : o_reg_196);

assign start_out = real_start;

assign t_fu_132_p2 = (t_i_reg_101 + 32'd1);

assign tmp_10_i_fu_144_p2 = ((o_fu_138_p2 == 32'd8) ? 1'b1 : 1'b0);
