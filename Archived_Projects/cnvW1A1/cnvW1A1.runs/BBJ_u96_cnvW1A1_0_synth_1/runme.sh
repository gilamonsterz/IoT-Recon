...
HD_PWD='D:/Adam/Documents/Vivado_Projects/IoT-Redeaux/Wrapped/cnvW1A1/cnvW1A1.runs/BBJ_u96_cnvW1A1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BBJ_u96_cnvW1A1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BBJ_u96_cnvW1A1_0.tcl
