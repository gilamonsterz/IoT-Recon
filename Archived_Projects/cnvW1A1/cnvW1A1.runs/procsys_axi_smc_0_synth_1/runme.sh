...
HD_PWD='/home/adam/BNN-PYNQ/bnn/src/network/output/vivado/cnvW1A1-ultra96/cnvW1A1-ultra96.runs/procsys_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log procsys_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source procsys_axi_smc_0.tcl
