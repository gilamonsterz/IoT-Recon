...
proc create_root_design { parentCell } {
  ...
  set ap_rst_n [ create_bd_port -dir O -from 0 -to 0 -type rst ap_rst_n ]
  ...
  connect_bd_intf_net -intf_net S00_AXI_0_1 [get_bd_intf_ports S00_AXI] [get_bd_intf_pins axi_smc/S00_AXI]
  ...
  connect_bd_net -net rst_ps8_0_299M_peripheral_aresetn1 [get_bd_ports ap_rst_n] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_299M/peripheral_aresetn]
