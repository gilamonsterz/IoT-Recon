...
wire    grp_StreamingMaxPool_fu_53_ap_start;
wire    grp_StreamingMaxPool_fu_53_ap_done;
wire    grp_StreamingMaxPool_fu_53_ap_idle;
wire    grp_StreamingMaxPool_fu_53_ap_ready;
wire    grp_StreamingMaxPool_fu_53_in_V_V_read;
wire   [63:0] grp_StreamingMaxPool_fu_53_out_V_V_din;
wire    grp_StreamingMaxPool_fu_53_out_V_V_write;
reg   [31:0] rep_i_reg_42;
wire    ap_CS_fsm_state3;
reg    grp_StreamingMaxPool_fu_53_ap_start_reg;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 3'd1;
#0 grp_StreamingMaxPool_fu_53_ap_start_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_StreamingMaxPool_fu_53_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state2) & (exitcond_i_fu_61_p2 == 1'd0))) begin
            grp_StreamingMaxPool_fu_53_ap_start_reg <= 1'b1;
        end else if ((grp_StreamingMaxPool_fu_53_ap_ready == 1'b1)) begin
            grp_StreamingMaxPool_fu_53_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((grp_StreamingMaxPool_fu_53_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
...
assign grp_StreamingMaxPool_fu_53_ap_start = grp_StreamingMaxPool_fu_53_ap_start_reg;

assign numReps_out_din = numReps_dout;

assign out_V_V_din = grp_StreamingMaxPool_fu_53_out_V_V_din;
