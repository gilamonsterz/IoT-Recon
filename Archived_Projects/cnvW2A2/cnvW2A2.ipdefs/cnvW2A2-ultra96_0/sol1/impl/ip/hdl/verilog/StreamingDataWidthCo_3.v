...
reg   [31:0] o_i_reg_85;
reg   [31:0] t_i_reg_97;
reg  signed [31:0] numReps_read_reg_177;
reg    ap_block_state1;
wire   [31:0] grp_fu_117_p2;
reg   [31:0] totalIters_reg_182;
wire    ap_CS_fsm_state6;
wire   [0:0] exitcond_i_fu_122_p2;
...
wire   [31:0] o_fu_133_p2;
reg   [31:0] o_reg_196;
wire   [0:0] tmp_i_1022_fu_139_p2;
reg   [0:0] tmp_i_1022_reg_201;
wire   [0:0] tmp_i_fu_145_p2;
reg   [0:0] tmp_i_reg_206_pp0_iter2_reg;
wire   [31:0] p_i_fu_151_p3;
reg    ap_enable_reg_pp0_iter1;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state7;
reg   [31:0] ap_phi_mux_o_i_phi_fu_89_p4;
reg   [63:0] ap_phi_mux_p_Val2_s_phi_fu_111_p4;
wire   [63:0] ap_phi_reg_pp0_iter0_p_Val2_s_reg_108;
reg   [63:0] ap_phi_reg_pp0_iter1_p_Val2_s_reg_108;
reg   [63:0] ap_phi_reg_pp0_iter2_p_Val2_s_reg_108;
reg   [63:0] ap_phi_reg_pp0_iter3_p_Val2_s_reg_108;
wire   [63:0] p_3_cast_i_fu_157_p1;
reg    ap_block_pp0_stage0_01001;
wire   [12:0] grp_fu_117_p1;
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_reg_187_pp0_iter2_reg == 1'd0) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        p_3_i_reg_73 <= {{ap_phi_mux_p_Val2_s_phi_fu_111_p4[63:32]}};
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        p_3_i_reg_73 <= 32'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_122_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_122_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        o_reg_196 <= o_fu_133_p2;
        tmp_i_1022_reg_201 <= tmp_i_1022_fu_139_p2;
    end
end
...
always @ (*) begin
    if ((exitcond_i_fu_122_p2 == 1'd1)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((exitcond_i_fu_122_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter2 == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter2 == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)) | ((exitcond_i_fu_122_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((exitcond_i_reg_187_pp0_iter2_reg == 1'd0) & (out_V_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((in_V_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (ap_predicate_op34_read_state9 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((exitcond_i_reg_187_pp0_iter2_reg == 1'd0) & (out_V_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((in_V_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (ap_predicate_op34_read_state9 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((exitcond_i_reg_187_pp0_iter2_reg == 1'd0) & (out_V_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((in_V_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (ap_predicate_op34_read_state9 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state10_pp0_stage0_iter3 = ((exitcond_i_reg_187_pp0_iter2_reg == 1'd0) & (out_V_V_full_n == 1'b0));
end
...
assign ap_phi_reg_pp0_iter0_p_Val2_s_reg_108 = 'bx;

always @ (*) begin
    ap_predicate_op34_read_state9 = ((tmp_i_reg_206 == 1'd1) & (exitcond_i_reg_187_pp0_iter1_reg == 1'd0));
end

assign ap_ready = internal_ap_ready;

assign exitcond_i_fu_122_p2 = ((t_i_reg_97 == totalIters_reg_182) ? 1'b1 : 1'b0);

assign grp_fu_117_p1 = 32'd3600;

assign numReps_out_din = numReps_dout;

assign o_fu_133_p2 = (32'd1 + ap_phi_mux_o_i_phi_fu_89_p4);

assign out_V_V_din = ap_phi_mux_p_Val2_s_phi_fu_111_p4[31:0];

assign p_3_cast_i_fu_157_p1 = p_3_i_reg_73;

assign p_i_fu_151_p3 = ((tmp_i_1022_reg_201[0:0] === 1'b1) ? 32'd0 : o_reg_196);

assign start_out = real_start;

assign t_fu_127_p2 = (t_i_reg_97 + 32'd1);

assign tmp_i_1022_fu_139_p2 = ((o_fu_133_p2 == 32'd2) ? 1'b1 : 1'b0);

assign tmp_i_fu_145_p2 = ((o_i_reg_85 == 32'd0) ? 1'b1 : 1'b0);
