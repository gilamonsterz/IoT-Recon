...
HD_PWD='D:/Adam/Documents/Vivado_Projects/IoT-Redeaux/PreRecon/cnvW2A2/cnvW2A2.runs/procsys_auto_ds_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log procsys_auto_ds_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source procsys_auto_ds_0.tcl
